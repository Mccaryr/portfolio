...
const Ship = ({isMobile}) => {
  ...
  useFrame((state, delta) => {
    // Rotate the spaceship based on its movement along the X-axis
  ...
  return (
    <mesh>
      ...
      <primitive object={scene} scale={isMobile ? 4.0 : 2.75} position={[position.x, position.y, position.z]} ref={spaceship} />
    </mesh>
  )
}
